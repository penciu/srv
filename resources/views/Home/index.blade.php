...
@section('content')
                    ...
                    <div class="col-lg-6">
                        <div class="rt-banner-content home-four">
                            ...
                            <p class="wow fade-in-top" data-wow-duration="1.4s" data-wow-delay="0.4s">
                                With a contactless
                                <b>{{$account_info !=NULL ? $account_info->application_name:'CHEF MENU'}}</b> Menu.<br>
                                Make your restaurant a safe place to eat or grab-and-go by deploying a touch-free QR
                                Code menu.
                            </p>
            ...
            <div class="row smallgap">
                <div class="col-xl-3 col-lg-4  col-md-6 col-12 mx-auto rt-mb-10">
                    <div
                        ...
                        <div class="iconbox-content">
                            <h5 class="f-size-24 rt-semiblod title-bar bg-3">Safety First</h5>
                            <p class="f-size-15 line-height-25 rt-mb-0">Limiting the use of physical menus and promoting
                                touchless QR Code menus reduces the risk of virus transmission, and keeps your customers
                ...
                <div class="col-xl-3 col-lg-4  col-md-6 col-12 mx-auto rt-mb-10">
                    <div
                        ...
                        <div class="iconbox-content">
                            <h5 class="f-size-24 rt-semiblod title-bar bg-2">No app download required</h5>
                            <p class="f-size-15 line-height-25 rt-mb-0">Your diners can scan the QR Code using their phone's camera </p><br><br><br>
                ...
                <div class="col-xl-3 col-lg-4  col-md-6 col-12 mx-auto rt-mb-10">
                    <div
                        ...
                        <div class="iconbox-content">
                            <h5 class="f-size-24 rt-semiblod title-bar bg-1">Easy to build & update</h5>
                            <p class="f-size-15 line-height-25 rt-mb-0">Create contactless menu QR Codes under 3 minutes. Later, upload & save a new menu to the same QR Code. </p><br><br><br>
                ...
                <div class="col-xl-3 col-lg-4  col-md-6 col-12 mx-auto rt-mb-10">
                    <div
                        ...
                        <div class="iconbox-content">
                            <h5 class="f-size-24 rt-semiblod title-bar bg-4">Inspires the confidence to step out</h5>
                            <p class="f-size-15 line-height-25 rt-mb-0">Re-align your restaurant functioning with contactless at the core. </p><br><br>
                ...
                <div class="col-lg-6 rt-mb-md-30">
                    <div class="rt-flow-parent text-center rtbgprefix-contain" data-scrollax-parent="true">
                        ...
                        <div class="flow-img-item"
                            ...
                            <img src="themes/default/images/banner/mbl-mockup-1.png" alt="" class="pulse_animation_image">
                        </div><!-- /.flow-img-item -->
                    </div><!-- /.rt-flow-parent -->
                </div><!-- /.col-lg-6 -->
                <div class="col-lg-6">
                    <h2 class="rt-section-title">
                        Benefits of a contactless menu
                    </h2>
                    ...
                    <div class="rt-single-icon-box   plain-list3  rt-mb-30">
                        ...
                        <div class="iconbox-content">
                            <h5 class="f-size-24 f-size-xs-20 rt-mb-15  rt-strong">Safer to use</h5>

                            <p class="f-size-15 line-height-25 rt-mb-0"> Germ-free, greener, quicker and safer than the traditional menu.</p>
                        </div><!-- /.iconbox-content -->
                    ...
                    <div class="rt-single-icon-box   plain-list3  rt-mb-30">
                        ...
                        <div class="iconbox-content">
                            <h5 class="f-size-24 f-size-xs-20 rt-mb-15  rt-strong">COVID Compliant</h5>
                            <p class="f-size-15 line-height-25 rt-mb-0">COVID compliance without single use paper menus or disinfectant.</p>
                        </div><!-- /.iconbox-content -->
                    </div><!-- /.rt-single-icon-box   plain-list   -->
                    <div class="rt-single-icon-box   plain-list3 ">
                        ...
                        <div class="iconbox-content">
                            <h5 class="f-size-24 f-size-xs-20 rt-mb-15  rt-strong">Easy to update</h5>
                            <p class="f-size-15 line-height-25 rt-mb-0">Use the menu builder to instantly change your menu. No re-prints!</p>
                        </div><!-- /.iconbox-content -->
                    </div><!-- /.rt-single-icon-box   plain-list   -->
                    ...
                    <div class="col-lg-6" style="margin-top: 65px;">
                        ...
                        <p class="rt-mb-0">
                           1. Use the phone camera or QR Application to scan the code.
                            <br>
                            2. Scroll around the menu and make your order.<br>
    ...
    <div class="rt-container" id="how">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mx-auto rt-mb-30">
                <div class="rt-single-icon-box icon-center  wow fade-in-bottom bg-transparent text-center  animated" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fade-in-bottom;">
                    ...
                    <div class="iconbox-content">
                        <h5 class="f-size-24 rt-semiblod rt-mb-15">Register</h5>
            ...
            <div class="col-lg-3 col-md-6 mx-auto rt-mb-30">
                <div class="rt-single-icon-box icon-center  wow fade-in-bottom bg-transparent text-center animated" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fade-in-bottom;">
                    ...
                    <div class="iconbox-content">
                        <h5 class="f-size-24 rt-semiblod rt-mb-15">Create Menu</h5>
                        <p class="f-size-15 line-height-26 rt-mb-0">Create your menu visible for your customers.
                        </p>
            ...
            <div class="col-lg-3 col-md-6 mx-auto rt-mb-30">
                <div class="rt-single-icon-box icon-center  wow fade-in-bottom bg-transparent text-center animated" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fade-in-bottom;">
                    ...
                    <div class="iconbox-content">
                        <h5 class="f-size-24 rt-semiblod rt-mb-15">Print QR Code</h5>
                        <p class="f-size-15 line-height-26 rt-mb-0">Put the printed tags on your tables.
                        </p>
            ...
            <div class="col-lg-3 col-md-6 mx-auto rt-mb-30">
                <div class="rt-single-icon-box icon-center  wow fade-in-bottom bg-transparent text-center animated" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fade-in-bottom;">
                    ...
                    <div class="iconbox-content">
                        <h5 class="f-size-24 rt-semiblod rt-mb-15">Receive Orders</h5>
                        <p class="f-size-15 line-height-26 rt-mb-0">When they order something, you get notified instantly!
                        </p>
    ...
    <section class="rt-site-footer bg_footer2 home-five title_bar_footer rtbgprefix-cover" style="background-image: url(themes/default/images/all-img/footer-bg4.png);">
                ...
                <div class="rt-container">
                    <div class="row">
                        <div class="col-lg-4 rt-mb-md-20">
                            <div class="media">
                                <img src="themes/default/images/all-icon/footer-icon-1.png" class="rt-mr-20" alt="post_image">
                        ...
                        <div class="col-lg-4 rt-mb-md-20">
                            <div class="media">
                                <img src="themes/default/images/all-icon/footer-icon-2.png" class="rt-mr-20" alt="post_image">
                                <div class="media-body text-white">
                        ...
                        <div class="col-lg-4">
                            <div class="media">
                                <img src="themes/default/images/all-icon/footer-icon-3.png" class="rt-mr-20" alt="post_image">
                                <div class="media-body text-white">
